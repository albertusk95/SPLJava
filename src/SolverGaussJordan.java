...
public class SolverGaussJordan {
	...
	//KONSTRUKTOR
	public SolverGaussJordan (double[][] matriks, int baris_eff, int kolom_eff, int tampilProses, int jenisOutput) {
		hasilOutput = matriks;
		row_eff = baris_eff;
		col_eff = kolom_eff;
			...
			if (count > 0) {
				...
				*/
				...
				for (indexA = 0; indexA < row_eff; indexA++) {
					...
					/*
						PROSES MEMBUAT SEMUA ELEMEN DI ATAS DAN DI BAWAH 1 UTAMA MENJADI NOL
